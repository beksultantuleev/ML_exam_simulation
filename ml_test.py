...
{'Recall is proportion of true negatives over all the elements that actually belong to the positive class':'f'},
...
{'Consider a dataset with n points in d dimensions. As a result, in least squares methods, we have to find the solutions of a set of n equations in d variables':'t'},
...
{'The scalar product between y^T∙x is a valid model for a neuron, where x and y are two different input vectors':'f'},
